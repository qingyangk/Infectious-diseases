  ...
  <div id="sentiment">
    ...
    <div id="left">
      <div class="left">
        ...
        <div id="matrix" style="height: calc(100% - 35px);width: 100%;z-index: 2;top: 35px;position: absolute;" />
      </div>
      <div class="right">
        <div class="top">高频情感占比</div>
        <div id="proportion" style="height: calc(100% - 35px);width: 100%;z-index: 2;top: 35px;position: absolute;" />
      </div>
    </div>
    <!-- 中部 -->
    <div id="center">
      <ul>
        <li>
          ...
          <div id="source" style="height: calc(100% - 35px);width: 100%;z-index: 2;top: 35px;position: absolute;" />
        </li>
        <li>
          <el-carousel arrow="never">
            <el-carousel-item v-for="item in 2" :key="item">
              <div v-if="item === 1">
                ...
                <div id="positive" style="height: calc(100% - 35px);width: 100%;z-index: 2;bottom: 35px;position: absolute;" />
              </div>
              <div v-if="item === 2">
                <div class="bottom">负面讨论</div>
                <div id="negative" style="height: calc(100% - 35px);width: 100%;z-index: 2;bottom: 35px;position: absolute;" />
              </div>
            </el-carousel-item>
          </el-carousel>
        </li>
        <li>
          ...
          <div id="hsearch" style="height: calc(100% - 35px);width: 100%;z-index: 2;top: 35px;position: absolute;" />
        </li>
      </ul>
    </div>
    <!-- 右侧 -->
    <div id="right">
      <ul>
        ...
        <li class="publiz">
          <div id="neirong">
            <section v-for="(value, index) in Journalisz" :id="value.id" :key="index">
              <h3>{{ value.title }}</h3> <!-- 标签 -->
              <p>{{ value.summary }}</p> <!-- 内容 -->
              <div class="diceng">
                <span>{{ value.time }}</span> <!-- 时间 -->
                <span>{{ value.infoSource }}</span> <!-- 来源 -->
              </div>
            </section>
          </div>
        </li>
...
export default {
  ...
  methods: {
    ...
    creatmap(TDate) {
      ...
      // 滚动切换
      document.getElementById('neirong').addEventListener('scroll', function() {
        ...
        for (var i = 0; i < chapterNames.length; i++) {
          ...
          if (bounds.top - 120 < 150 && bounds.bottom - 230 > 0) {
            ...
            document.getElementById(that.activeChapterName).setAttribute('class', '')
