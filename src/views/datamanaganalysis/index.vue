...
<script>
// import i from './components/public/font/'
import tuoyuan from './components/tuoyuan'
import jvbu from './components/jvbu'
import lengre from './components/lengre'

export default {
  name: 'Datamanaganalysis',
  components: {
    tuoyuan,
    jvbu,
    lengre
