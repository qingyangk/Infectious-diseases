  ...
  <div id="login" class="login-container">
    ...
    <div class="loginbody">
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
        ...
        <el-button type="primary" class="public" @click="handleLogin(0)">登录</el-button>
      </el-form>
    </div>
...
<script>
import { validUsername, validEmail, validTelephone, validLetter, validPassword } from '@/utils/validate'
...
export default {
  ...
  data() {
    const validateUsername = (rule, value, callback) => {
      if (!validUsername(value) && !validEmail(value) && !validTelephone(value) && !validLetter(value)) {
        ...
        this.$refs.loginForm.validate(valid => {
          if (valid) {
            ...
            this.$store.dispatch('user/login', this.loginForm).then(() => {
              ...
              this.loading = false
              var data = [{ name: '滁州市', where: 2, code: 341100 }, { name: '南京市', where: 2, code: 320100 }, { name: '陕西省', where: 1, code: 610000 }, { name: '上海市', where: 1, code: 310000 }, { name: '深圳市', where: 2, code: 440300 }, { name: '琅琊区', where: 3, code: 341102 }] // 创建值
