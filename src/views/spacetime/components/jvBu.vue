<template>
  <div id="jvbu" style="position: absolute;width: 100%;height: 100%">
...
export default {
  ...
  data() {
    return {
      ...
      url: 'http://110.40.187.212:6080/arcgis/rest/services/ShaanXiDisease/service/MapServer/2',
      url12: 'http://110.40.187.212:6080/arcgis/rest/services/ShaanXiDisease/service/MapServer/3',
      // 查询底图
  ...
  beforeDestroy() {
    ...
    eventBum.$off('data')
    eventBum.$off('space')
    document.getElementById('jvbu').style.display = 'none'
  },
  mounted() {
    // 城市尺度
  ...
  methods: {
    ...
    _Init: function() {
      ...
      loadModules(
        ...
        const gpUrl = 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/LMoran/GPServer/%E5%B1%80%E9%83%A8%E8%87%AA%E7%9B%B8%E5%85%B3'
    ...
    areaQuery(sqlwhere, sqlwhereurl, e) {
      ...
      //     // 加载地图方法
      //     var mapUrl = 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/LMoran/MapServer/jobs/' + jobInfo2.jobId
