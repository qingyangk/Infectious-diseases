<template>
  <div id="lenre" style="position: absolute;width: 100%;height: 100%">
...
export default {
  ...
  beforeDestroy() {
    ...
    eventBum.$off('json')
    eventBum.$off('data')
    document.getElementById('lenre').style.display = 'none'
  },
  mounted() {
    // 城市尺度
  ...
  methods: {
    ...
    _Init: function() {
      ...
      loadModules(
        ...
        const gpUrl = 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/ColdAndHotSpotAnalysis/GPServer/%E5%86%B7%E7%83%AD%E7%82%B9%E5%88%86%E6%9E%90'
    ...
    areaQuery(sqlwhere, sqlwhereurl, e) {
      ...
      //     // 加载地图方法
      //     var mapUrl = 'http://114.98.239.36:6080/arcgis/rest/services/ShaanXiDisease/ColdAndHotSpotAnalysis/MapServer/jobs/' + jobInfo2.jobId
