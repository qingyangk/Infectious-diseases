    ...
    <el-row v-if="roles == 'virus'" :gutter="10">
      ...
      <el-col :span="7">
        <div>
          <div class="lefts">
            <el-link
              class="harf activation"
              type="primary"
              :underline="false"
              href="/#/datapanel"
              ><icon-svg icon-class="icon-shishijiance" class="img" />
              数据面板</el-link
            >
            <el-link
              class="harf"
              ...
              :underline="false"
              href="/#/query/index"
              ><icon-svg icon-class="icon-chaxun" class="img" />
              查询统计</el-link
            >
            <el-link
              class="harf"
              type="primary"
              :underline="false"
              href="/#/datamanag/index"
              ><icon-svg icon-class="icon-ziyuan143" class="img" />
              数据管理</el-link
            >
            <el-link
              class="harf"
              ...
              :underline="false"
              href="/#/map/index"
              ><icon-svg icon-class="icon-iconditubianji" class="img" />
              专题地图</el-link
            >
          </div>
        </div>
        ...
        <div>
          <div class="rights">
            <el-link
              ...
              type="primary"
              :underline="false"
              href="/#/spacetime/index"
              ><icon-svg icon-class="icon-shikong-kongjian" class="img" />
              时空分析</el-link
            >
            <el-link
              class="harf"
              ...
              href="/#/forecast/index"
              ><icon-svg
                icon-class="icon-weiwangguanicon-defuben-"
                class="img"
              />
              模拟预测</el-link
            >
            <el-link
              ...
              type="primary"
              :underline="false"
              href="/#/communicationmap/index"
              ><icon-svg icon-class="icon-tupushujuyuan" class="img" />
              传播调查</el-link
            >
            <el-link
              class="harf"
              ...
              ><icon-svg icon-class="icon-yuqingjiankong" class="img" />
              舆情分析</el-link
            >
      ...
      <el-col :span="1">
        <div>
          <el-link
            ...
            :underline="false"
            href="/#/datamanag/index"
            ><icon-svg icon-class="icon-yonghu"
          /></el-link>
        </div>
        <div class="right-menu">
          <template>
...
export default {
  ...
  computed: {
    ...mapGetters(["sidebar", "avatar", "power", "roles"]),
  },
  mounted() {
    var that = this;
  ...
  methods: {
    ...
    async jihuo() {
      ...
      if (this.index < 100) {
        harf[this.index].className =
          harf[this.index].className + " " + "activation";
      }
    },
  },
};
